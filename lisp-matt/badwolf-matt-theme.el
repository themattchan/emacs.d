...
(let* ((plain "#f8f6f2")
  ...
  (custom-theme-set-faces
   ...
   `(highlight-indent-guides-odd-face ((t (:foreground ,brightgravel))))
   `(highlight-indent-guides-even-face ((t (:foreground ,lightgravel))))
   `(highlight-indent-guides-character-face ((t (:foreground ,gravel))))
