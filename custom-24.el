(custom-set-variables
 ...
 '(haskell-mode-hook
   (quote
    (#[nil "\301\211\207"
           ...
           2]
     inf-haskell-mode interactive-haskell-mode matt/functional-programming
     #[nil "\300\301!\207"
 ...
 '(package-selected-packages
   (quote
    (intero znc yaml-mode writeroom-mode writegood-mode wolfram-mode wc-mode wc-goal-mode w3 utop use-package tuareg top-mode tabbar sublime-themes stripe-buffer stack-mode spotify spaces spacegray-theme soft-stone-theme sml-mode smartparens sicp shm shell-command seti-theme scheme-complete scf-mode flx-ido scala-outline-popup rainbow-delimiters racket-mode quack psci paredit pandoc-mode osx-plist org-pandoc org-journal nose nginx-mode multi-web-mode multi-term monokai-theme moe-theme menu-bar+ memory-usage marmalade load-theme-buffer-local lex latex-preview-pane latex-pretty-symbols keyfreq jtags json-mode js3-mode js2-mode jedi-direx impatient-mode image+ igrep iedit idomenu ido-ubiquitous ido-load-library ido-hacks ido-complete-space-or-hyphen ido-at-point icicles hy-mode hippie-expand-slime helm-make helm-ls-svn helm-ls-hg helm-ls-git helm-gitlab helm-gitignore helm-git helm-ghc helm-flyspell helm-flycheck helm-company helm-ag-r haml-mode graphviz-dot-mode gitconfig git-commit-mode git-blame git-auto-commit-mode git-annex git gist fuzzy fsharp-mode fringe-helper framesize fold-dwim-org flyparens flymake-racket flymake-python-pyflakes flymake-hlint flymake-haskell-multi flylisp flycheck-pos-tip flycheck-ocaml flycheck-liquidhs flycheck-hdevtools flycheck-haskell flycheck-ghcmod flycheck-elm flycheck-color-mode-line flycheck-clojure fill-column-indicator feature-mode expand-region exec-path-from-shell ess-smart-underscore ess-smart-equals ess-R-object-popup ess-R-data-view emamux elscreen elpy electric-case ecb dot-mode display-theme dirtree dired-details+ dired+ dash-functional ctags-update ctags company-web company-cabal company-c-headers company-auctex color-theme coffee-mode clojure-test-mode cfengine-code-style button-lock bison-mode autopair auto-complete-auctex auctex-lua anything-git-grep anything-git-files anything-exuberant-ctags ag adjust-parens ac-slime ac-math ac-ispell ac-haskell-process ac-geiser ac-etags ac-cider ac-c-headers zenburn-theme web-mode visual-fill-column spacemacs-theme solarized-theme smart-mode-line slime python-mode projectile neotree markdown-mode magit helm-ag helm go-mode furl flycheck swiper find-file-in-project evil ess scala-mode2 ensime elm-mode ein company-ghci company-ghc company-coq company cider auto-complete auctex-latexmk)))
