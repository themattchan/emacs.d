(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (nlinum doom-themes dr-racket-like-unicode helm-hoogle helm-idris lsp-haskell lsp-mode nodejs-repl ecb olivetti intero yaml-mode wc-mode use-package tuareg smartparens sicp shm seti-theme racket-mode pandoc-mode org-journal nginx-mode monokai-theme moe-theme menu-bar+ js2-mode iedit icicles helm-ls-git helm-flyspell helm-company haml-mode git-auto-commit-mode git-annex gist fsharp-mode flycheck-pos-tip flycheck-hdevtools flycheck-clojure feature-mode expand-region exec-path-from-shell emamux elpy dot-mode django-mode dash-functional zenburn-theme web-mode visual-fill-column spacemacs-theme solarized-theme slime python-mode projectile neotree markdown-mode magit helm-ag helm go-mode furl flycheck swiper find-file-in-project ess ensime elm-mode ein company-math yasnippet company cider auto-complete docker-tramp scala-outline-popup git-commit-mode flymake-racket clojure-test-mode scala-mode2 znc writeroom-mode writegood-mode wolfram-mode wc-goal-mode w3 utop top-mode tabbar sublime-themes stripe-buffer stack-mode spotify spaces spacegray-theme soft-stone-theme sml-mode smart-mode-line shell-command scheme-complete scf-mode rainbow-delimiters quack psci protobuf-mode paredit osx-plist org-pandoc nose multi-web-mode multi-term memory-usage marmalade load-theme-buffer-local lex latex-preview-pane latex-pretty-symbols keyfreq jtags json-mode js3-mode jedi-direx impatient-mode image+ igrep idomenu ido-ubiquitous ido-load-library ido-hacks ido-complete-space-or-hyphen ido-at-point hy-mode hippie-expand-slime helm-ls-svn helm-ls-hg helm-gitlab helm-gitignore helm-git helm-ghc helm-flycheck helm-ag-r haskell-emacs-text haskell-emacs-base graphviz-dot-mode gitconfig git-blame git fuzzy fringe-helper framesize fold-dwim-org flyparens flymake-python-pyflakes flymake-hlint flymake-haskell-multi flylisp flycheck-ocaml flycheck-liquidhs flycheck-haskell flycheck-ghcmod flycheck-elm flycheck-color-mode-line flx-ido fill-column-indicator evil ess-smart-underscore ess-smart-equals ess-R-object-popup ess-R-data-view elscreen electric-case display-theme dirtree dired-details+ dired+ ctags-update ctags company-web company-ghci company-ghc company-coq company-cabal company-c-headers company-auctex color-theme coffee-mode cfengine-code-style button-lock bison-mode autopair auto-complete-auctex auctex-lua auctex-latexmk anything-git-grep anything-git-files anything-exuberant-ctags ag adjust-parens ac-slime ac-math ac-ispell ac-haskell-process ac-geiser ac-etags ac-cider ac-c-headers)))
