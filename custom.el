(custom-set-variables
 ...
 '(safe-local-variable-values
   (quote
    ((dante-repl-command-line "nix-shell" "--run" "cabal repl lib:shipit --builddir=dist/dante")
